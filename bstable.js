...
class BSTable 
{
  ...
  var deleteValue="";
	...
	$cols.each(function() {
        ...
        if ($(column).attr('input')=='bstable-actions') {
	...
	location.href="/vcnetTemp/reg_action_page.php?action=edit&info="+deleteValue;
	//alert(deleteValue);
  ...
  var allcolumvalues="";
	...
	location.href="/vcnetTemp/reg_action_page.php?action=Insertregtbl&info="+allcolumvalues;
	 //alert(allcolumvalues);
  }
  _rowCancel(button) {
  // Reject the changes
    var $row = $(button).parents('tr');       // access the row
